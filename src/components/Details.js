    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                {
                    opacity: headerSeasonToggle, transform: [{ translateY: 0 },
                    { translateX: headerSeasonHide }]
                }]}>

                    {this.getLastSeason() == 1 ?
                        <TouchableHighlight>
                ...
                <Animated.ScrollView
                    ...
                    <ImageBackground style={styles.thumbnail} source={this.renderThumbnail()}>
