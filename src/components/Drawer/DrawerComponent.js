...
class DrawerComponent extends Component {
    ...
    _onMenuSelected = (element) => {
        this.props.navigation.navigate('DrawerClose')
        setTimeout(() => {
            this.props.onMenuselected(element)
        }, 0)
    }
    ...
    _renderItemsMenu() {
        ...
        return genres.map((element, key) => (
            <TouchableOpacity
                ...
                onPress={this._onMenuSelected.bind(this, element)}>
...
export default connect(mapStateToProps, mapDispacthToProps)(DrawerComponent)